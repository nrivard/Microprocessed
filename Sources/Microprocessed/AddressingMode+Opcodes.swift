...
extension Instruction.AddressingMode {
    ...
    enum Opcodes {
        ...
        static let absolute: [UInt8] = [0x0C, 0x0D, 0x0E, 0x1C, 0x20, 0x2C, 0x2D, 0x2E, 0x4C, 0x4D, 0x4E, 0x6D, 0x6E, 0x8C, 0x8D, 0x8E, 0x9C, 0xAD, 0xAE,
                                        0xCC, 0xCD, 0xCE, 0xD9, 0xEC, 0xED, 0xEE, 0xF9]
        ...
        static let absoluteIndexed: [UInt8] = [0x19, 0x1D, 0x1E, 0x39, 0x3C, 0x3D, 0x3E, 0x59, 0x5D, 0x5E, 0x79, 0x7D, 0x7E, 0x99, 0x9D, 0x9E, 0xB9, 0xBC,
                                               0xBD, 0xBE, 0xDD, 0xDE, 0xFD, 0xFE]
        ...
        /// #
        static let immediate: [UInt8] = [0x09, 0x29, 0x49, 0x69, 0x89, 0xA0, 0xA2, 0xA9, 0xC0, 0xC9, 0xD0, 0xE0, 0xE9]
        ...
        /// s
        static let stack: [UInt8] = [0x00, 0x08, 0x28, 0x40, 0x48, 0x5A, 0x60, 0x6A, 0x68, 0x7A, 0xDA, 0xFA]
        ...
        /// (zp, x)
        static let zeroPageIndexedIndirect: [UInt8] = [0x01, 0xA1, 0x21, 0x41, 0x61, 0x81, 0xA1, 0xC1, 0xE1]

        /// zp,x and zp,y
        static let zeroPageIndexed: [UInt8] = [0x15, 0x16, 0x34, 0x35, 0x36, 0x55, 0x56, 0x74, 0x75, 0x76, 0x94, 0x95, 0x96, 0xB4, 0xB5, 0xB6, 0xD5, 0xD6, 0xF5,
                                               0xF6]

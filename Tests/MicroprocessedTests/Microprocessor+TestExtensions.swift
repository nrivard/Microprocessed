//
//  Microprocessor+TestExtensions.swift
//  
//
...
extension Microprocessor {
    ...
    /// convenience that writes an opcode and 1-byte of data at the address pointed to by PC
    ...
    /// convenience that writes an opcode and 2-bytes of data at the address pointed to by PC

...
extension Instruction.Mnemonic {
    ...
    enum Opcodes {
        ...
        // MARK: - Unused
        //
        // unused (or unknown). 65C02's unused opcodes are guaranteed noops
        static let unused: Set<UInt8> = [0x02, 0x03, 0x0B, 0x13, 0x1B, 0x22, 0x23, 0x2B, 0x33, 0x3B, 0x42, 0x43, 0x44, 0x4B, 0x53, 0x54, 0x5B, 0x5C, 0x62, 0x63,
